<template>
  <button
    class="font-heading w-full px-6 py-4 text-base text-gray-900 bg-transparent border border-gray-400 hover:gray-100 rounded-md group relative overflow-hidden"
  >
